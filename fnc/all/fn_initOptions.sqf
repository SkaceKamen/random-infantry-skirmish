...
RSTF_SPAWN_CLASSIFICATION_RATIOS = false;
RSTF_SPAWN_CLASSIFICATION_AI_RATIO = 1;
RSTF_SPAWN_CLASSIFICATION_AT_RATIO = 0.1;
RSTF_SPAWN_CLASSIFICATION_AA_RATIO = 0.1;

// Override the ratios for enemy
RSTF_SPAWN_CLASSIFICATION_ENEMY_RATIOS = false;
RSTF_SPAWN_CLASSIFICATION_ENEMY_AI_RATIO = 1;
RSTF_SPAWN_CLASSIFICATION_ENEMY_AT_RATIO = 0.1;
RSTF_SPAWN_CLASSIFICATION_ENEMY_AA_RATIO = 0.1;
