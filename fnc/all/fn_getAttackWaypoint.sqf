...
// Random waypoint inside defended area for defend
if (RSTF_MODE_DEFEND_ENABLED) exitWith {
...
// Random waypoint inside circle for arena
if (call RSTF_fnc_getModeId == 'Arena') exitWith {
	private _distance = RSTF_RANDOM_SPAWN_WIDTH / 2;
	private _point = RSTF_POINT;
	private _distance2 = _distance * _distance;
